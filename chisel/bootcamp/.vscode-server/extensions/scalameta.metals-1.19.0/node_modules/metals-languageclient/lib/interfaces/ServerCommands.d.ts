...
export declare const ServerCommands: {
    ...
    readonly DecodeFile: "file-decode";
    /** Retrieve a list of all build targets */
    readonly ListBuildTargets: "list-build-targets";
    /**
    ...
    readonly GotoPosition: "goto-position";
     ...
     */
    readonly NewJavaFile: "new-java-file";
    ...
    readonly ScalaCliStart: "scala-cli-start";
    /** Stop the Scala CLI server. */
    readonly ScalaCliStop: "scala-cli-stop";
