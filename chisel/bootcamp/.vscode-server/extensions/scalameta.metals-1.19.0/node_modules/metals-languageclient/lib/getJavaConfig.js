...
exports.getJavaConfig = void 0;
const getJavaOptions_1 = require("./getJavaOptions");
const path = __importStar(require("path"));
function getJavaConfig({ workspaceRoot, javaHome, extensionPath, coursierMirrorFilePath, customRepositories = [], }) {
    const javaOptions = getJavaOptions_1.getJavaOptions(workspaceRoot);
